...
get_prebuilts() {
	...
	log "CLI: [${RV_CLI_JAR#"$TEMP_DIR/"}](https://github.com/j-hc/revanced-cli/releases/latest)"
	...
	log "Integrations: [${RV_INTEGRATIONS_APK#"$TEMP_DIR/"}](https://github.com/revanced/revanced-integrations/releases/latest)"
	...
	log "Patches: [${RV_PATCHES_JAR#"$TEMP_DIR/"}](https://github.com/revanced/revanced-patches/releases/latest)"
