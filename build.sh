...
DEF_DPI_LIST=$(toml_get "$main_config_t" dpi-list) || DEF_DPI_LIST="nodpi anydpi"
read -r -a DPI_CANDIDATES <<<"$DEF_DPI_LIST"
...
for table_name in $(toml_get_table_names); do
	...
	app_args[dpi]=$(toml_get "$t" dpi) || app_args[dpi]="any"
